        ...
        <div className="center">
          ...
          <div className="row align-items-left">
            <div className="col-md-6 mt-5">
              ...
              <p style={{paddingBottom: 1 + 'em'}}>He is the owner of state of the art tattoo studio called Saints Touch in Gothenburg, Sweden and is known for his black, white and greyscale works. He has inked up A-List celebrities like <strong>Post Malone, Lewis Hamilton, Alesso and Nyjah Huston,</strong> just to name a few and shares photos of his masterpieces to his over 50k followers.</p>
